...
import 'package:dharmlok/views/ProfileDetailPage/profile_detail_page.dart';
...
class DharmguruPageWidget extends StatelessWidget {
  DharmguruPageWidget({Key? key}) : super(key: key);
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            const ImageIcon(
                              AssetImage(AppAssets.dharmaGuruImageWhite),
                              color: Colors.brown,
                              size: 50,
                            ),
                            const Padding(
                                                    ...
                                                    builder: (context) =>
                                                      ...
                                                      child:
                                                        ...
                                                        name: vendorModel
                                                            ...
                                                            .name,
                                                        category:
                                                            'Dharmguru/${vendorModel.vendorDetails[index].category}',
                                                        profileImageUrl:
                                                            vendorModel
                                                                .vendorDetails[
                                                                    index]
