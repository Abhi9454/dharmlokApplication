...
class JainAartiPageWidget extends StatefulWidget {
  const JainAartiPageWidget({Key? key}) : super(key: key);

  @override
  State<JainAartiPageWidget> createState() => _JainAartiPageWidgetState();
}

class _JainAartiPageWidgetState extends State<JainAartiPageWidget>
